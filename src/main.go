...
func main() {
	...
	log.PrettyPrint(weatherData.Hourly.Time)
	log.PrettyPrint(weatherData.Hourly.Temp)
	log.PrettyPrint(weatherData.Hourly.ApperentTemp)
	log.PrettyPrint(weatherData.Hourly.Precipitation)
